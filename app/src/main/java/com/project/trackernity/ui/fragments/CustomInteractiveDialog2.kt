...
import com.project.trackernity.databinding.CustomDialogInteractive2Binding
...
class CustomInteractiveDialog2(mainViewModel:MainViewModel):DialogFragment() {
    private var _binding: CustomDialogInteractive2Binding? = null
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        _binding = CustomDialogInteractive2Binding.inflate(LayoutInflater.from(context))
