package com.project.trackernity.util
...
object MapUtils {
    ...
    fun getPointMarkerBitmap(context: Context): Bitmap {
        val bitmap = BitmapFactory.decodeResource(context.resources, R.drawable.ic_point_marker)
